...
export default function Header () {
  return (
    <div>
      ...
      <div className='w-screen h-screen grid grid-cols-1 lg:grid-cols-2 md:pt-28'>
        ...
        <div className='flex flex-col text-center items-center mb-10 lg:justify-center lg:order-1 lg:pr-16'>
          ...
          <p className='text-white my-2 md:w-3/5 lg:w-2/4'>Freelance, developer, student and self-taught passionate about web development and design.</p>
